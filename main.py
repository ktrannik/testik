...
RP_TRIGGERS = {
    ...
    "прочесть дневник джодаха": {
     ...
     "стирание": {
        "type": "target",
        "responses": [
            "{user} стёр все воспоминания у {target} 🫡 ",
            "{user} стёр все воспоминания у {target} но сам был отправлен на стирание 🫠",
            "{user} не смог стереть память {target} из-за модуля П.Е.Р.С.И.К 🤖",
        ]
    },
     "кавински": {
        "type": "self",
        "responses": [
            "{user} сходил на свиданку вместе с Кавински 🎩",
            "{user} был послан Кавински и тот уехал в закат 🌅 "
        ]
    },
     "селенцио бруно": {
        "type": "self",
     ...
     "гильдия": {
        ...
        "responses": [
            ...
            "{user} не смог(-а-) вступить ни в какую гильдию и возглавил(-а-) гильдию дасков🌟",
     ...
     "камео": {
        ...
        "responses": [
            ...
            "{user} в твою комнату ворвалась Ричард и начал устраивать над тобой пранки🫤"
        ]
    },
     "ликвидация": {
        "type": "target",
        "responses": [
            "{user} успешно ликвидировал по воле Рехобоама {target}🖥",
            "{user} не смог провести постликвидацию {target} и за это был отправлен в Пансионат🏥",
            "{user} успешно ликвидировал выжившего в ветке {target} и потратил все синкоины на игры🎰",
            "{user} не смог ликвидировать по воле Рехобоама {target} и сам был ликвидирован☠️",
