...
RP_TRIGGERS = {
    "чай джейса": {
        "type": "self",
        "responses": [
            "{user} умер(-ла-) от переизбытка маны ☠️",
            "{user} выпил(-а-) чай Джейса и почувствовал прилив сил! 🧙"
        ]
    },
    "пузатый лис": {
        "type": "target",
        "responses": [
            "{user} выпил(-а-) одуванчиковое пиво вместе с {target} 🍺",
    ...
    "тюрьма времени": {
        "type": "target",
        "responses": [
            "{user} запечатал(-а-) в самой ужасной тюрьме {target} 🔳",
            "У {user} не удалось запечатать {target}! 🤯"
        ]
    },
    "прочесть дневник джодаха": {
        "type": "self",
        "responses": [
            "{user} открыл(-а-) дневник и ужаснулся(-ась-) от количества поглощённых душ 😨",
     ...
     "смотрящий": {
        ...
        "responses": [
            ...
            "{user} посмотрел(-а-) на Смотрящего и заметил(-а-) лёгкий интерес в его взгляде 👀",
            "{user} посмотрел(-а-) на Смотрящего и заметил(-а-) безразличие в его взгляде 👀",
            "{user} посмотрел(-а-) на Смотрящего и ничего не увидел(-а-) в его взгляде 👀",
            "{user} посмотрел(-а-) на Смотрящего и продрог(-ла-) от холода 👀",
     ...
     "аномалия": {
        "type": "self",
        "responses": [
            "{user} увидел(-а-) аномалию с Мистером О'Флафферти и был испепелён его лазерами💥 ",
            "{user} увидел(-а-) аномалию врат Отправления и даже не обратил внимания 🟣",
            "{user} увидел(-а-) аномалию с очками Джона и теперь ходит с модными очками 😎",
            "{user} увидел(-а-) аномалию со Смотрящим и повеяло холодом ❄️",
            "{user} увидел(-а-) аномалию с отвязкой и едва не погиб от перегрузки 😵‍💫 ",
            "{user} увидел(-а-) аномалию с ужасными монстрами и активировал Искру ✴️",
            "{user} увидел(-а-) аномалию со скинтонитом и решил взять ее с собой (это была ошибка)❌ ",
            "{user} увидел(-а-) аномалию с мечом Путешественника и решил что он идеально подходит для нарезки салата (и не только) ⚔️",
            "{user} увидел(-а-) аномалию с Воплощёнными и закрылся в сонном измерении на месяц 🏠 ",
            "{user} увидел(-а-) аномалию с масками Первых и на него нахлынули старые воспоминания 🎭 ",
            "{user} увидел(-а-) аномалию с взломанным Г.Л.А.С и решил что повременит с белым пространством ⬜️ ",
            "{user} благодаря аномалии смог узнать имя другого существа и навалял ему 🤩 ",
            "{user} услышал(-а-) от Риз очередную чересчур знакомую фразу, что же это может значить? 🤔",
            "{user} увидел(-а-) аномалию и переместился в белое пространство 👻 ",
     ...
     "тысяча глаз": {
        ...
        "responses": [
            ...
            "{user} не смог(-ла-) использовать Тысячу глаз из-за перешёптывания демонов в голове 👹 ",
     ...
     "стирание": {
        ...
        "responses": [
            ...
            "{user} стёр(-ла-) все воспоминания у {target} и сам(-а-) был отправлен(-а-) на стирание 🫠",
     ...
     "кавински": {
        ...
        "responses": [
            ...
            "{user} был(-а-) послан Кавински и тот уехал в закат 🌅 "
        ]
    },
     "селенцио бруно": {
        "type": "self",
        "responses": [
            ...
            "{user} был(-а-) превращен(-а-) в Лефтариона и чуть не разрушил свой дом 🐉",
            "{user} был(-а-) превращен(-а-) в Джодаха и проспойлерил(-а-) себе сюжет будущих сезонов 🤦‍♂️",
            "{user} был(-а-) превращен(-а-) в Бастиана и его говорящие животные что-то заподозрили 🧐",
            "{user} был(-а-) превращен(-а-) в Верону и сломал(-а) ловушку Варнера 🤫",
            "{user} был(-а-) превращен(-а-) в Смотрящего и познал(-а-) саму суть Времени ⏳",
            "{user} был(-а-) превращен(-а-) в Варнера и тот быстро устранил конкурента ☠️",
     ...
     "гильдия": {
        ...
        "responses": [
            ...
            "{user} вступил(-а-) в гильдию убийц и начал(-а-) разрабатывать свой злобный план🟥",
            "{user} вступил(-а-) в гильдию контрабадистов и учуял(-а-) запах навара🟫",
            "{user} вступил(-а-) в гильдию пряностников и начал(-а-) думать, как бы продать что-то подороже🟧",
            "{user} вступил(-а-) в гильдию магов и открыл(-а-) портал🟦",
     ...
     "камео": {
        ...
        "responses": [
            ...
            "{user} в твою комнату ворвался Лололошка прямо через окно🪟",
            "{user} в твою комнату ворвалась Окетра и чуть не сделала тебя своим новым абдом😰",
            "{user} в твою комнату ворвался Дилан и попробовал открыть твои настройки пока не понял, что ты не автоматон🤖",
            "{user} в твою комнату ворвался Джон Дейви Харрис и теперь это его дом🤯",
            "{user} в твою комнату ворвался Павел и выбил дверь🚪 ",
            "{user} в твою комнату ворвалась аномалия из М47 и ты даже не обратил(-а-) внимание🙄",
            "{user} в твою комнату ворвались уборщики и начали укладывать тебя спать🛌",
            "{user} в твою комнату ворвались культисты Возродителя и начали ритуал🩸",
            "{user} в твою комнату ворвался Тадмавриэль и придал Очищению🧟",
            "{user} в твою комнату ворвался сотрудник Организации и вежливо предложил револьвер🔫",
            "{user} в твою комнату ворвалась Айко и проглотила дом целиком🐍",
            "{user} в твою комнату ворвался Кавински и вы хорошо побеседовали под документалку про тюленей🦭",
            "{user} в твою комнату ворвалась Райя-Прайм и решила протестировать на тебе идеальную формулу еды🍫",
            "{user} в твою комнату ворвался Войд и потребовал срочно кофе☕️",
            "{user} в твою комнату ворвался Джодах и рассказал как однажды проиграл Вселенную из-за пива🍺",
